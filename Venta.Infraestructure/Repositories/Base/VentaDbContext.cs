...
namespace Venta.Infraestructure.Repositories.Base
{
    public class VentaDbContext : DbContext
    {
        ...
        {
            #region Configuración de las entidades en el mismo ModelCreating
            ...
            //        p.HasOne(p => p.Producto).WithMany(p => p.VentaDetalle)
            //            .HasForeignKey(p => p.IdProducto);
            //    }
            //);
            #endregion

            // Configuración las entidades en archivos de tipos separados
